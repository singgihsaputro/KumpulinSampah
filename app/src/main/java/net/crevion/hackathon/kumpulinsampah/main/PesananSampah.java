...
public class PesananSampah extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    // Log tag
    private static final String TAG = PesananSampah.class.getSimpleName();
    static final String idPembeli = "201503002";
    // Billionaires json url
    private static final String url = "http://crevion.net/kumpulinsampah/public/index.php/sampah/pesanan_sampahku/"+idPembeli;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pesanan_sampah);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent myIntent = new Intent(PesananSampah.this, DetailPesanan.class);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                sampahModel.setNama("Pembeli : " + obj.getString("nama"));
                                sampahModel.setTanggal("Tanggal pesan : " + obj.getString("tanggal_pesan"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_daftar_sampah) {
            Intent myIntent = new Intent(PesananSampah.this, MainActivity.class);
            myIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(myIntent);
        } else if (id == R.id.nav_sampahku) {
            Intent myIntent = new Intent(PesananSampah.this, Sampahku.class);
            myIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(myIntent);
